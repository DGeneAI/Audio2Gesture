...
wav = torch.randn(1,13056000)
wav = wav.reshape(-1,800*12)
z = model.feature_extractor(wav)
target_size = 800*12/(16000/20)
interpolated_z = F.interpolate(z, size=target_size, mode='linear', align_corners=False)
interpolated_z = interpolated_z.squeeze(2)
